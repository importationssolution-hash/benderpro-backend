...
// ═══════════════════════════════════════════════════════════════════
// EXECUTION REELLE DES TRADES (bot.js) — declenchee automatiquement
...
async function runBotCycle() {
  if (botRunning) {
    console.log('[Bot] Cycle precedent encore en cours — on attend le prochain');
    return;
  }
  botRunning = true;
  try {
...
// Cycle Futures — execution reelle separee, declenchee aussi chaque minute
let futuresBotRunning = false;
async function runFuturesBotCycle() {
  if (futuresBotRunning) {
    console.log('[Futures] Cycle precedent encore en cours — on attend le prochain');
    return;
  }
