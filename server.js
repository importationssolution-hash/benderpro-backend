...
app.post('/create-checkout-session', async (req, res) => {
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      mode: 'subscription',
      // Note : payment_method_types n'est plus specifie manuellement -- les comptes
      // Stripe recents utilisent "Managed Payments" qui choisit automatiquement les
      // methodes de paiement disponibles (carte, etc.). Fixer ce parametre soi-meme
      // causait une erreur "Unsupported parameter" sur ces comptes.
